...
|:------------:|:-----------:|:-----------:|
| [**N. Curti**](https://github.com/Nico-Curti) | **gbmseg**<br>[![American Journal of Nephrology](https://img.shields.io/badge/AJN-g.svg)]() | [![license](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/Nico-Curti/glomerular-basement-membrane/blob/main/LICENSE) |
...
Official implementation of the pipeline published on [Americal Journal of Nephrology]() by Curti et al. [![American Journal of Nephrology](https://img.shields.io/badge/AJN-g.svg)]().
...
If you have found `gbmseg` helpful in your research, please consider citing the original paper about the wound image segmentation
